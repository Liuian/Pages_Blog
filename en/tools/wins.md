...
## search ip
- `ipconfig`
    - ![alt text](/Pages_Blog/assets/images/tools/wins-1.png)
...
4. 查看電腦品牌: 
    ...
    - ![alt text](/Pages_Blog/assets/images/tools/wins-2.png)
...
1. `this pc` -> `map network drive`
    - ![alt text](/Pages_Blog/assets/images/tools/wins-linux-server-0.png)
    - ![alt text](/Pages_Blog/assets/images/tools/wins-linux-server-1.png)
    - ![alt text](/Pages_Blog/assets/images/tools/wins-linux-server-2.png)
2. in wins powershell: 
    - `wsl`
    - `sudo mkdir -p /mnt/z`
    - `sudo mount -t drvfs Z: /mnt/z`
    - `cd /mnt/z`
    - ![alt text](/Pages_Blog/assets/images/tools/wins-linux-server-3.png)
...
- split windows: Right-click on the PowerShell icon in the taskbar and select `split tab`.
    - ![alt text](/Pages_Blog/assets/images/tools/wins-4.png)
    - ![alt text](/Pages_Blog/assets/images/tools/wins-3.png)
- `alt` + `shift` + `↑ / ↓ / ← / →` ：調整窗格大小
...
- ![alt text](/Pages_Blog/assets/images/tools/winscp-1.png)
